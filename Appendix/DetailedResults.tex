...
\begin{landscape}
  {\linespread{1.0}
    \begin{table}
      \input{Regression_Results/Intl/mod1_fit_All_Volatility.tex}
    \end{table}
    \begin{table}
      \input{Regression_Results/Intl/mod1_contemporaneousControls_fit.tex}
    \end{table}
    \begin{table}
      \input{Regression_Results/Intl/mod1_fit_All_Volatility_withLags_withFundcontrols.tex}
    \end{table}
    \begin{table}
      \input{Regression_Results/Intl/mod1_fit_All_Volatility_std_withLags_withFundcontrols.tex}
    \end{table}
  }
\end{landscape}
...
\begin{landscape}
  {\linespread{1.0}
    \begin{table}
      \input{Regression_Results/Intl/mod2_fit_All_Liquidity_BidAsk.tex}
    \end{table}
    \begin{table}
      \input{Regression_Results/Intl/mod2_fit_All_Liquidity_BidAsk_withFundcontrols.tex}
    \end{table}
    \begin{table}
      \input{Regression_Results/Intl/mod2_fit_All_Liquidity_Amihud.tex}
    \end{table}
    \begin{table}
      \input{Regression_Results/Intl/mod2_fit_All_Liquidity_Amihud_withFundcontrols.tex}
    \end{table}
  }
\end{landscape}
...
\begin{landscape}
  {\linespread{1.0}
    \begin{table}
      \input{Regression_Results/Intl/mod3_fit_All_VR.tex}
    \end{table}
    \begin{table}
      \input{Regression_Results/Intl/mod3_fit_All_VR_withFundcontrols.tex}
    \end{table}
    \begin{table}
      \input{Regression_Results/Intl/mod3_fit_All_absVR.tex}
    \end{table}
    \begin{table}
      \input{Regression_Results/Intl/mod3_fit_All_absVR_withFundcontrols.tex}
    \end{table}
  }
\end{landscape}
