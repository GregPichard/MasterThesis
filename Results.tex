...
\begin{landscape}
  {\linespread{1.0}
    %\begin{table}[htbp]
    % \input{./Regression_Results/Intl/mod1_comp.tex}
    %\end{table}
    \input{./Regression_Results/Intl/mod1_comp_long.tex}
  }
\end{landscape}
...
\begin{landscape}
  {\linespread{1.0}
    \begin{table}[htbp]
      \input{./Regression_Results/Intl/mod2_comp.tex}
    \end{table}
  }
\end{landscape}
...
\begin{landscape}
  {\linespread{1.0}
    \begin{table}[htbp]
      \input{./Regression_Results/Intl/mod3_comp.tex}
    \end{table}
  }
\end{landscape}
