...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  4 14:07:28 2019
...
Stocks_AdditionalVariables_db = pd.read_csv('Monthly/AdditionalVariables_Stocks_Monthly_db.csv', header = None, index_col = 0)
...
Stocks_BidAsk_db.to_csv('Monthly/Stocks_BidAskSpread_db.csv', index = True, header = True)
...
Stocks_GrossProfit_db.to_csv('Monthly/Stocks_GrossProfit_db.csv', index = True, header = True)
