...
AmihudNumerator_MonthlyPanel = pd.read_csv('Monthly/Stocks_AmihudNumerator_WidePanel.csv', header = 0)
AmihudNumerator_db = pd.melt(AmihudNumerator_MonthlyPanel, id_vars = ['Date'], var_name = 'RIC', value_name = 'AmihudNumerator')

AmihudDenominator_MonthlyPanel = pd.read_csv('Monthly/Stocks_AmihudDenominator_WidePanel.csv', header = 0)
...
for df in list([GrossProfit_db, ControlVariables_db, ReturnCloseVolatility_db, AmihudRatio_db, AmihudNumerator_db, AmihudDenominator_db, BidAsk_db]):
...
MonthlyVariables_db = pd.concat([ETF_Holdings_LongMerged_db, NonETF_Holdings_LongMerged_db, ReturnCloseVolatility_db, AmihudRatio_db, AmihudNumerator_db, AmihudDenominator_db, BidAsk_db, RetPast12to1M_db, RetPast12to7M_db, GrossProfit_db, ControlVariables_db], axis = 1)
