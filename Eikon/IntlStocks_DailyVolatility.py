...
import xarray
import datetime
print("Loading Price and volume data (large table > 6.5 GB)")
...
Stocks_Close_Daily_db.to_csv('Monthly/IntlStocks_Close_Daily_db.csv')
Stocks_Close_Daily_db = pd.read_csv('Monthly/IntlStocks_Close_Daily_db.csv', header = 0, nrows= 10)
