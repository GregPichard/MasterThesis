...
def Loop_Stocks(ric_list, date):
    ...
    while initial_value < N_stocks:
        ...
        try:
            ...
            #print(OutShares)
            OutShares.to_csv("Monthly/BasicOutstandingShares_Stocks_Monthly_db.csv", mode = 'a', header = False)
            OutShares.to_hdf("Monthly/BasicOutstandingShares_Stocks_Monthly_db.hdf", key = 'out_shares', complevel = 6, complib = 'zlib')
